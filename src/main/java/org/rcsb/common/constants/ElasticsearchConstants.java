...
public class ElasticsearchConstants {
    ...
    public static final String INDEX_SUGGESTER_COMP_MODEL = "comp_model_suggester";
    
    public static final String INDEX_TERMS_COMPLETION = "terms_autocomplete";
    public static final String INDEX_TERMS_COMPLETION_COMP_MODEL = "comp_model_terms_autocomplete";

    public static final String INDEX_UNSTRUCTURED_ENTRY = "unstructured_entry";
    public static final String INDEX_UNSTRUCTURED_ENTRY_COMP_MODEL = "comp_model_unstructured_entry";

    public static final String INDEX_DENORMALIZED_ENTRY = "combined_entry";
    public static final String INDEX_DENORMALIZED_ENTRY_COMP_MODEL = "comp_model_combined_entry";

    public static final String INDEX_DENORMALIZED_ASSEMBLY = "combined_assembly";
    public static final String INDEX_DENORMALIZED_ASSEMBLY_COMP_MODEL = "comp_model_combined_assembly";

    public static final String INDEX_DENORMALIZED_POLYMER_ENTITY = "combined_polymer_entity";
    public static final String INDEX_DENORMALIZED_POLYMER_ENTITY_COMP_MODEL = "comp_model_combined_polymer_entity";

    public static final String INDEX_DENORMALIZED_POLYMER_ENTITY_INSTANCE = "combined_polymer_instance";
    public static final String INDEX_DENORMALIZED_POLYMER_ENTITY_INSTANCE_COMP_MODEL = "comp_model_combined_polymer_instance";
